...
class MeshAnnotator(QMainWindow):
    ...
    def add_description(self):
        ...
        try:
            self.status_label.setText("状态: 进入点选模式，按住Shift并点击两个点...")
            ...
            if len(picked_indices) != 2:
                self.status_label.setText("状态: 请点选两个点")
                QMessageBox.warning(self, "点选错误", "请确保点选两个点")
                return
            ...
            if len(instance_ids) != 2:
                self.status_label.setText("状态: 未选择两个有效实例点")
                QMessageBox.warning(self, "选择错误", "请确保点选的是有实例ID的区域")
                return
            ...
            new_annotation = {
                ...
                "distance_m": round(distance, 4),  # 距离保留4位小数
