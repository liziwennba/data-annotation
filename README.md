...
### 问题示例
1. **首先，最正对的茶几可以作为目标问题，那么问题可以是：**  
   `刚进门背对着门，正对着我可以承载东西的物体是？#`
（此处需要‘#‘，因为问题已经完整，不需要语义信息）（这种问题就很好，感谢多提这种）
2. **假如我并不知道面前这个东西是什么，也没有其他的描述给它（它不是最近的，沙发更近，所以用最近的描述时需要它的语义）**  
   `刚进门背对着门，正对我并离我最近的` + 点选【可以承载东西的物体】
（此处不需要‘#’，因为问题并不完整，【】中的内容是我们后期添加的，你只需要标记”刚进门背对着门，正对我并离我最近的“，并点选问题即可。）

3. **进门左手边还有且仅有一个黄色的盆栽，那么问题可以是：**  
   `刚进门背对着门，左手边的物体是？#`  
   `刚进门背对着门，左手边黄色的物体是？#`

   **也可以是：**
   `刚进门背对着门，左手边` +点选-----> **我们后处理过之后**：`刚进门背对着门，左手边【用于观赏的生物】`
   （这种问题质量一般，请不要提太多）
